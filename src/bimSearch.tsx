...
export function BimSearch(props: { viewer: VIM.Viewer, filter: string, setFilter :(s:string) => void }){
  ...
  return <div className="vim-bim-search mb-4 flex">
    ...
    <input className="w-full bg-transparent border-b border-gray-light focus-within:outline-none focus-within:border-primary-royal placeholder-text-gray-medium py-1 px-6"
      type="search"
      name="name" 
