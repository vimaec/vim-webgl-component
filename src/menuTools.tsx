...
export function MenuTools(props: {viewer: VIM.Viewer, moreMenuVisible:boolean, setMoreMenuVisible: (b:boolean) => void }){
  ...
  const btnOrbit = <button data-tip="Orbit" onClick={() => console.log('Orbit')} className={`rounded-full text-black h-10 w-10 flex items-center justify-center transition-all hover:scale-110 hover:bg-hover-t40`} type="button"><Icons.Orbit height="24" width="24" fill="currentColor" /></button>
  const btnFirstPerson = <button data-tip="First Person" onClick={() => console.log('First Person')} className={`rounded-full text-black h-10 w-10 flex items-center justify-center transition-all hover:scale-110 hover:bg-hover-t40`} type="button"><Icons.FirstPerson height="24" width="24" fill="currentColor" /></button>
  const btnPan = <button data-tip="Pan" onClick={() => console.log('Pan')} className={`rounded-full text-black h-10 w-10 flex items-center justify-center transition-all hover:scale-110 hover:bg-hover-t40`} type="button"><Icons.More height="24" width="24" fill="currentColor" /></button>
  const btnDolly = <button data-tip="Dolly" onClick={() => console.log('Dolly')} className={`rounded-full text-black h-10 w-10 flex items-center justify-center transition-all hover:scale-110 hover:bg-hover-t40`} type="button"><Icons.More height="24" width="24" fill="currentColor" /></button>
  const btnFrameMouse = <button data-tip="Frame Mouse" onClick={() => console.log('Frame Mouse')} className={`rounded-full text-black h-10 w-10 flex items-center justify-center transition-all hover:scale-110 hover:bg-hover-t40`} type="button"><Icons.Box height="24" width="24" fill="currentColor" /></button>
  const btnFrame = <button data-tip="Frame" onClick={() => console.log('Frame')} className={`rounded-full text-black h-10 w-10 flex items-center justify-center transition-all hover:scale-110 hover:bg-hover-t40`} type="button"><Icons.Box height="24" width="24" fill="currentColor" /></button>
  ...
  return <div className='vim-menu flex items-center justify-center w-full fixed px-2 bottom-0 py-2 divide-x-2 bg-white'>
    <div className ='vim-menu-section flex items-center'>
      ...
      <div className='mx-1'>{btnFirstPerson}</div>
      <div className='mx-1'>{btnPan}</div>
      <div className='mx-1'>{btnDolly}</div>
      <div className='mx-1'>{btnFrameMouse}</div>
